package me.raymondcai.graphql.datastore;
...
public class CharacterRepository {
    ...
    private Map<Episode, Actor> heroes;
    ...
    public CharacterRepository() {
        ...
        Map<Episode, Actor> heroes = new HashMap<>();
    ...
    public Map<String, Actor> getCharacters() {
        return characters;
    }

    public Map<Episode, Actor> getHeroes() {
        return heroes;
    }
}