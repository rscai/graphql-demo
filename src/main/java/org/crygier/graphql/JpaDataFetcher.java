...
public class JpaDataFetcher implements DataFetcher {
    ...
    protected Predicate getPredicate(CriteriaBuilder cb, Root root, DataFetchingEnvironment environment, Argument argument) {
        Path path = null;
    ...
    protected Attribute getAttribute(DataFetchingEnvironment environment, Argument argument) {
